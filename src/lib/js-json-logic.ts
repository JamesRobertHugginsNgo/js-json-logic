...
export const blockMap = new WeakMap<Block, Record<string, Block>>();

function getBlockOf(name: string, vars: Block[]) {
...
export function addConstructorOperator<T>(name: string, cls: Constructor<T>): void {
	const operator = (args: any[], vars: Block[]): any => {
...
export function evaluate(rule: any, vars: Block[]): any {
